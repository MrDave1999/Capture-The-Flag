...
{
	//Remove objects from area 51 map.
	RemoveBuildingForPlayer(playerid, 16664, 268.6641, 1885.4297, 7.8828, 0.25);
	RemoveBuildingForPlayer(playerid, 3399, 268.7031, 1889.5234, 4.8438, 0.25);
	//Remove objects from crack factory map.
	...
	RemoveBuildingForPlayer(playerid, 2525, 2579.5391, -1286.6484, 1064.3750, 0.25);
	RemoveBuildingForPlayer(playerid, 2527, 2581.1172, -1283.1563, 1064.3672, 0.25);
	RemoveBuildingForPlayer(playerid, 2524, 2582.9922, -1284.1172, 1064.3750, 0.25);
	RemoveBuildingForPlayer(playerid, 2526, 2581.7656, -1286.6797, 1064.3594, 0.25);
	//Remove objects from RC Battlefield map.
    RemoveBuildingForPlayer(playerid, 3940, -974.4453, 1041.5391, 1347.1484, 0.25);
