...
public OnFilterScriptInit()
{
	...
	SetObjectMaterial(tmpobjid, 0, 16136, "des_telescopestuff", "ws_palebrickwall1", 0xFFFFFFFF);
	tmpobjid = CreateObject(19790, 614.41949, 1720.63928, 488.95920,   0.00000, 0.00000, 0.00000);
	SetObjectMaterial(tmpobjid, 0, 6867, "vgnpwrmainbld", "sw_wallbrick_02", 0xFFFFFFFF);
	tmpobjid = CreateObject(19790, 638.11603, 1721.27319, 488.95920,   0.00000, 0.00000, 0.00000);
	SetObjectMaterial(tmpobjid, 0, 6867, "vgnpwrmainbld", "sw_wallbrick_02", 0xFFFFFFFF);
	return 1;
}